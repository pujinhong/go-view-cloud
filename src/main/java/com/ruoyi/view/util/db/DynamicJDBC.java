package com.ruoyi.view.util.db;

import com.alibaba.druid.pool.DruidDataSource;
import com.ruoyi.view.service.IDataSourceService;
import com.ruoyi.view.util.ConvertUtil;
import com.ruoyi.view.util.ReflectHelper;
...
public class DynamicJDBC {
    ...
    private MapSqlParameterSource buildParameters(Map<String, Object> columnValues) {
        ...
        for (Map.Entry<String, Object> entry : columnValues.entrySet()) {
            if (entry.getValue() instanceof String && ConvertUtil.isDateString((String) entry.getValue())) {
                // 如果值是时间字符串，则转换为时间对象
                parameters.addValue(entry.getKey(), ConvertUtil.parseDateString((String) entry.getValue()));
            } else {
